...
print("Naive-Bayes 1v")
nb_1v_output_path = "naiveBayes-1v/"
if not os.path.exists(nb_1v_output_path):
    os.makedirs(nb_1v_output_path)
...
pickle.dump(predictions_values_per_visit, open(nb_1v_output_path + "predictions.pkl", "wb"))
pickle.dump(predictions_raw_values_per_visit, open(nb_1v_output_path + "predictions_raw.pkl", "wb"))
pickle.dump(real_values_per_visit, open(nb_1v_output_path + "real_values.pkl", "wb"))
